...
class ServiceMessagesHandler(threading.Thread):
    ...
    def RREQ_handler(self, dsr_header, RREQ):
        ...
        #if RREQ.next_hop_ip == self.node_ip or RREQ.source_ip == self.node_ip:
        #    print "This is my own RREQ, do nothing\n"
        #    #self.rreq_idip_pairs[RREQ.id] = [RREQ.next_hop_ip]
        ...
        #self.rreq_idip_pairs[RREQ.id].append(RREQ.next_hop_ip)
        self.rreq_ids.append(RREQ.id)
