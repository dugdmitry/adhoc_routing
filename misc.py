...
# int_header = int(header, 16) >> 8
#
# print int_header
#
# header_unpacked = Header.from_buffer_copy(binascii.a2b_hex(hex(int_header << 8)[2:]))
#
# print header_unpacked
#
# for field in header_unpacked._fields_:
#     print getattr(header_unpacked, field[0])
